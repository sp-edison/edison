...
<div class="virtitlebox"><img src="${contextPath }/images/title_virtual.png" width="20" height="20" /> 
	...
	<div class="search01">
		...
		<div class="searchbox01">
			<input id="<portlet:namespace/>search_parameter" name="<portlet:namespace/>search_parameter" type="text" maxlength="15" placeholder="<liferay-ui:message key='edison-virtuallab-search-option' />" onkeypress="<portlet:namespace/>onKeyDown();"/>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tbody>
					...
					<tr class="puptrline">
						...
						<td class="puptxt">
							<input id="<portlet:namespace/>userScreenName" name="<portlet:namespace/>userScreenName" class="dialogInput" type="text" readonly="readonly" style="width:140px; margin-bottom:0px;"/>
						</td>

	...
	<form id="searchForm" name="searchForm" method="post" onsubmit="return false;">
		...
		<div class="search01">
			<div class="searchbox01">
				<input id="<portlet:namespace/>userScreenName" name="<portlet:namespace/>userScreenName" type="text" maxlength="15" placeholder="<liferay-ui:message key='edison-table-list-header-userid' />" style="margin-bottom:0px;" onkeypress="<portlet:namespace/>onKeyDown();"/>

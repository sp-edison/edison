...
public class managementAppController {
	...
	public void myAppList(ResourceRequest request, ResourceResponse response) throws IOException{
		try {
			...
			params.put("languageId", themeDisplay.getLanguageId());
			params.put("searchText", searchText);
			params.put("begin", start);
			params.put("end", listSize*currentPage);
			
			List<Map<String, Object>> myAppList = ScienceAppLocalServiceUtil.getMyAppListForProject(params, locale);
			int totalCount = ScienceAppLocalServiceUtil.getMyAppListForProjectCount(params, locale);

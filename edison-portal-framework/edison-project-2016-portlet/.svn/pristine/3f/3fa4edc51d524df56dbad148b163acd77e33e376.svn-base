...
public class managementContentController {
	...
	public void myContentForProjectList(ResourceRequest request, ResourceResponse response){
		try{
			...
			String projectCategoryId = CustomUtil.strNull(param.get("projectCategoryId"));
			...
			List<Map<String, Object>> dataList = GeneralContentLocalServiceUtil.getGeneralContentForProjectList(userId, searchText, projectCategoryId, themeDisplay.getLanguageId(), start, listSize*currentPage, locale);

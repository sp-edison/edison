	...
	protected Map<String,Object> tabCreateAndStatusButtonView(long scienceAppId, boolean swTest,String clickTab, Locale locale) throws PortalException, SystemException{
		...
		if(scienceAppId == 0){
			...
			if(swTest){
				...
				long scienceAppOutputPortsCnt = ScienceAppOutputPortsLocalServiceUtil.getScienceAppOutputPortsesCount(scienceAppId);
				
				if(scienceAppInputPortsCnt==0&&scienceAppOutputPortsCnt==0){
					tabsStr +=",m03fail";
				}else{
